...
from modelsd.networks import Reg_Domain
...
def main(args):
    ...
    # Recording
    csv_path = '/home/zhanghaoyu/csv/Pretrain-model.csv'
...
if __name__ == '__main__':
    ...
    # model
    argparser.add_argument('--dataset', help='Dataset: Kadid, ChallengeDB or KonIQ', default='kadid-P')
    argparser.add_argument('--model_name', help='Name of model to be saved', default='Pretrain-modeld3')
    ...
    argparser.add_argument('--ckptd', help='Path to checkpoint',
                           default='/home/zhanghaoyu/GraphIQA-master/ckptd/pretrain_modeld3')
    argparser.add_argument('--gpus', default=1, type=int, help='number of gpu')
    argparser.add_argument('--gpu_id', type=str, default='1', help='GPU ID')

    # RL setting
    argparser.add_argument('--lr', type=float, help='learning rate', default=1e-7)
    ...
    argparser.add_argument('--csv_path', help='file list of meta-test dataset', default='/home/zhanghaoyu/GraphIQA-master/data/kadid10k/25_types_csv/')
    argparser.add_argument('--dataset_path', help='Path to dataset', default='/home/zhanghaoyu/GraphIQA-master/data/kadid10k/images/')
