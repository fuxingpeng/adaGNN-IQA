...
def main(args):
    ...
    folder_path = {
        'live': '/home/zhanghaoyu/GraphIQA-master/data/LIVE',
        'csiq': '/home/zhanghaoyu/GraphIQA-master/data/csiq',
        'tid2013': '/home/zhanghaoyu/GraphIQA-master/data/tid2013',
        'livec': '/home/zhanghaoyu/GraphIQA-master/data/LIVE_WILD',
        'koniq': '/home/zhanghaoyu/GraphIQA-master/data/Koniq10k',
        #'bid': './data/BID',
        'kadid-F': '/home/zhanghaoyu/GraphIQA-master/data/kadid10k'
    }
...
if __name__ == '__main__':
    ...
    # model
    argparser.add_argument('--dataset', help='', default='csiq')
    argparser.add_argument('--model_name', help='Name of model to be saved', default='Pretrain-modeld')
